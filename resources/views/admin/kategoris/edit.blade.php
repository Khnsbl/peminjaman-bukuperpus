<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Edit Kategori Buku</h2>
    </x-slot>
    <div class="py-12">
                ...
                <form method="POST" action="{{ route('admin.kategoris.update', $kategori) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" rows="3"
                            class="w-full border rounded px-3 py-2">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="flex gap-3">
                        <button type="submit" class="flex-1 bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Simpan Perubahan</button>
